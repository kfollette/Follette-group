;+
; NAME: visao_reg_circsym_no_cont
;
; The visao_reg_circsym with lines involving cont commented out
;
; PURPOSE:
...
pro visao_reg_circsym_no_cont, clip=clip, flat=flat, fwhm=fwhm, indiv=indiv, scl=scl, stp=stp, mask=mask
