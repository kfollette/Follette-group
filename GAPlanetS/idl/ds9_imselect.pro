...
;  2016-02-24 Modified by Kate Follette to include "q" option to exit before going through entire image list
;
; BUGS/WISH LIST:
; add total preserved integration time and rotation in culled cube
;-
pro ds9_imselect, ims, index=index, usm=usm, sm=sm, iminfo=iminfo
  ...
  fnames = 0
  if(at eq 7) then fnames = 1  ;if ims is array with list of filenames
