...
dir = input()
os.chdir(str(dir))
hdulist = fits.open("Cont_clip450_flat_reg_circsym_nocosmics.fits")
cube = hdulist[0].data
hdulist.close()
...
if not os.path.exists("sliced_Cont/"):
    os.makedirs("sliced_Cont/")

os.chdir("sliced_Cont/")
...
for z in range(len(cube)):
    ...
    print("Sliced continuum image " + str(z+1))
