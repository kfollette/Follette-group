...
;
; PURPOSE:
;  Get the relative color values of the SAO "green" color table.
;
; DESCRIPTION:
;  Returns the relative color values of the SAO "green" color table, taken from default.C in the ds9 source.
...
; EXAMPLE:
;  
;  saoct_green, red_x, red_c, green_x, green_c, blue_x, blue_c
; 
;
; HISTORY:
...
;
;-
pro saoct_green, red_x, red_c, green_x, green_c, blue_x, blue_c
