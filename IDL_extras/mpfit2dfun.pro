...
;
; PURPOSE:
;   Perform Levenberg-Marquardt least-squares fit to a 2-D IDL
;   function
;
; MAJOR TOPICS:
...
;  data.
;
;  Given the data and their uncertainties, MPFIT2DFUN finds the best
;  set
...
;   - The name of an IDL function which computes Z given (X,Y)
;     ("MYFUNCT").
...
;             given the X,Y values and model parameters, as described
;             above.
;
...
;              for the returned parameter values, i.e. the chi-square
;              value.
;
...
;
;              DOF     = N_ELEMENTS(Z) - N_ELEMENTS(PARMS) ; deg of
;                                        freedom
...
;
;                1D/ERR^2 - Normal weighting (ERR is the measurement
;                           error)
...
;-
; Copyright (C) 1997-2000, 2002, 2003, 2004, 2005, 2013, 2016 Craig
; Markwardt
...
function mpfit2dfun_eval, p, dp, _EXTRA=extra
  ...
  ;; depending on whether (a) FUNCTARGS was passed to MPFIT2DFUN,
  ;; which
