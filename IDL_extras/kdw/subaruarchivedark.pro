pro subaruarchivedark,list
  ...
  FOR i=0,n-1 DO BEGIN
     ...
     darkname='../Dark-'+STRN(FXPAR(header,'NAXIS1'))+'-'+STRN(FXPAR(header,'EXPTIME'))+'.fits'
     IF FXPAR(header,'NAXIS1') eq 1024 THEN MWRFITS,CFHTMASK(MEDIAN(dark,DIMENSION=2)),darkname,header,/CREATE
