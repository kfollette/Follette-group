...
pro visao_reg_circsym_test, clip=clip, flat=flat, fwhm=fwhm, indiv=indiv, scl=scl, stp=stp, mask=mask
  ...
  ;;if clip keyword not defined (not recommended), image size is full array (1024x512)
