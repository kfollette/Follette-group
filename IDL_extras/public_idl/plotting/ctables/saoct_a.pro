...
;
; PURPOSE:
;  Get the relative color values of the SAO "a" color table.
;
; DESCRIPTION:
;  Returns the relative color values of the SAO "a" color table, taken from default.C in the ds9 source.
...
; EXAMPLE:
;  
;  saoct_a, red_x, red_c, green_x, green_c, blue_x, blue_c
; 
;
; HISTORY:
...
;
;-
pro saoct_a, red_x, red_c, green_x, green_c, blue_x, blue_c
  
red_x = [0., .25, .5, 1.]
red_c = [0., 0, 1., 1.]

green_x = [0., .25, .5, 0.77, 1.0]
green_c = [0., 1., 0., 0.,1.]

blue_x = [0., .125, 0.5, 0.64, 0.77, 1.0]
blue_c = [0.,0.,1.0, 0.5, 0., 0.]
