...
;       scalar. If SPEC is 2-D and if MOVE is a scalar, shift is
;       applied
...
; slooowwwww...
; 06.04.2003   JJ - Now uses linear interpolation by default and
;                   spline
...
; 06.14.2010   JJ - Fixed 2-D shifting bug to apply the fractional
;                   offset in correct direction. Thanks to Jared Rand
;                   for finding the bug.
;
;-
